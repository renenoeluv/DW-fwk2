...
<head>
    ...
    <link href="vendor/datatables.net-dt/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="vendor/datatables.net-buttons-dt/css/buttons.dataTables.min.css" rel="stylesheet">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="page-scroll" href="#tabla">Tabla</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
